...
<body class="bg-gray-50">
    <div class="max-w-3xl mx-auto px-4 py-8 md:py-12">
        ...
        <section class="bg-gray-100 rounded-lg p-6 mb-10 shadow-sm">
            ...
            <p class="text-gray-700 text-lg leading-relaxed mt-4">
                Here\u2019s a quick rundown of how David Lipscomb shook things up too: He was a big deal in the Churches of Christ, especially around South Nashville. Lipscomb liked the idea of lots of small churches instead of a few big ones\u2014kept everyone involved and let local talent shine. He\u2019d set up tent meetings where a preacher and a tent would kick off a new group, with help from nearby churches at first. He leaned on guys who had day jobs but still preached\u2014called bi-vocational ministers. They didn\u2019t need full church pay, just a strong faith and some study time. Take the South College Street Church (later Lindsley Avenue)\u2014by 1906, they\u2019d trained 9 or 10 of these working preachers in 18 years. It worked! Lipscomb\u2019s plan built a tight web of churches in Nashville with relatable, everyday guys preaching, making the whole thing feel grassroots and real.
            </p>
        </section>
    </div>
</body>
